...
PROJECT_NAME := provider-jet-cloudfoundry
PROJECT_REPO := github.com/poblin-orange/$(PROJECT_NAME)

export TERRAFORM_VERSION := 1.1.6

export TERRAFORM_PROVIDER_SOURCE := cloudfoundry-community/cloudfoundry
export TERRAFORM_PROVIDER_VERSION := 0.15.3
export TERRAFORM_PROVIDER_DOWNLOAD_NAME := terraform-provider-cloudfoundry

export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX := https://releases.hashicorp.com/terraform-provider-cloudfoundry/0.15.3
export TERRAFORM_NATIVE_PROVIDER_BINARY := terraform-provider-cloudfoundry_v0.15.3
...
IMAGES = provider-jet-cloudfoundry provider-jet-cloudfoundry-controller
